...
EPUBJS.Book.prototype.displayChapter = function(chap, end, deferred){
	console.log ("I am displaying a chapter");
	console.log (chap + ' is chapter and end is '+ end );
	for (var i = 0; i<11;i++){
		console.log (this.spine[i]);
	}
    ...
    console.log (pos + ' Is Pos and spine length is ' + this.spine.length)
